...
if($_POST['history_id']) {
    ...
    $sql = "SELECT
              ...
              tbl_service_history.customerName,
              tbl_service_history.model,
              tbl_service_history.serialNumber,
            ...
            INNER JOIN
              tbl_transfer_type ON tbl_transfer_type.transferType_id = tbl_service_history.transferType_id
            INNER JOIN
            ...
            WHERE
              tbl_service_history.history_id = ".$history_id."
            ORDER BY
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="col-md-6">
                ...
                <div class="input-group col-md-12">
                    <span class="input-group-addon" id="basic-addon1"><label class="text-danger"></label> Cost:</span><span class="input-group-addon" id="basic-addon1"><label class="text-danger"></label>₱</span>
                    <input type="number" name="cost" value="<?php echo $cost; ?>" class="form-control" id="cost" placeholder="00.00" aria-describedby="basic-addon1" required autofocus autocomplete="off">
                </div><br>
