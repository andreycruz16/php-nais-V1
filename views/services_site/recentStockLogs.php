...
<body>
                            ...
                            <div class="panel-body">
                                <br>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-condensed table-hover" id="recentStockLogs">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center" bgcolor="#f2ba7f" width="90">Reference&nbsp;Type</th>
                                                    <th class="text-center" bgcolor="#f2ba7f" width="">Reference&nbsp;#</th>
                                                    <th class="text-center" bgcolor="#f2ba7f" width="">Part&nbsp;#</th>
                                                    <th class="text-center" bgcolor="#f2ba7f" width="80">Quantity</th>
                                                    <th class="text-center" bgcolor="#f2ba7f" width="20">+&nbsp;/&nbsp;−</th>
                                                    <th class="text-center" bgcolor="#f2ba7f" width="10">Transfer&nbsp;Type</th>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th bgcolor="#f2ba7f" width="90">Reference&nbsp;Type</th>
                                                    <th bgcolor="#f2ba7f" width="">Reference&nbsp;#</th>
                                                    <th bgcolor="#f2ba7f" width="">Part&nbsp;#</th>
                                                    <th bgcolor="#f2ba7f" width="80">Quantity</th>
                                                    <th bgcolor="#f2ba7f" width="20">+&nbsp;/&nbsp;−</th>
                                                    <th bgcolor="#f2ba7f" width="10">Transfer&nbsp;Type</th>
                                            ...
                                            <?php 
                                                ...
                                                $sql = "SELECT
                                                        ...
                                                        FROM
                                                          tbl_service_history
                                                        INNER JOIN
                                                          tbl_service ON tbl_service_history.stock_id = tbl_service.stock_id
                                                        INNER JOIN
    ...
    <script>
            ...
            $(document).ready(function() {
                var table = $('#recentStockLogs').DataTable();
             
                $("#recentStockLogs tfoot th").each( function ( i ) {
