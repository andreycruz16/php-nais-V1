            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <button class="btn btn-primary btn-md" onclick="javascript:printTable()">
                            <span class="glyphicon glyphicon-print"></span>&nbsp; <?php  echo date("F d, Y"); ?> (Summary)
                        </button>
                    </div>
                </div><br>
                <div class="row">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="moreDetails.php?stock_id=<?php echo $stock_id; ?>" class="btn btn-primary btn-xs" disabled>Generate Report <span class="glyphicon glyphicon-list-alt"></span></a>
                                                    </td>
                                                </tr>
                                            <?php 
                                                    }
