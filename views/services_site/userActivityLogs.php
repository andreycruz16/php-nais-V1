...
<body>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-condensed table-hover" id="userActivityLogTable">
                                            <thead>
                                                <tr>
                                                    <th class="text-center" bgcolor="#e5e5e5" width="155">TIMESTAMP</th> <!-- 2 -->
                                                    <!-- <th bgcolor="#f2ba7f">User</th> --> <!-- 1 -->
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <!-- <th bgcolor="#f2ba7f">User</th> --> <!-- 1 -->
                                                    <th class="text-center" bgcolor="#f2ba7f" width="100">Activity&nbsp;Type</th> <!-- 3 -->
                                                    <td class="text-center" bgcolor="#f2ba7f"></td> <!-- 4 -->
                                                </tr>
                                            </tfoot>
                                            <tbody>
                                            <?php 
    ...
    <script>
            ...
            $(document).ready(function() {
                var table = $('#userActivityLogTable').DataTable();
             
                $("#userActivityLogTable tfoot th").each( function ( i ) {
