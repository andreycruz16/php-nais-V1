...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $image_file = 'QrCodes/'.$_POST['partNumber'].'.png';
...
$pdf->SetTitle('ItemReport_'.$description.'_'.$dateFrom.'_'.$dateTo);
...
<strong>From: </strong><i>'.date('M d, Y', strtotime($dateFrom)).'</i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<strong>To: </strong><i>'.date('M d, Y', strtotime($dateTo)).'</i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<br><br>
...
$sql = "SELECT 
        ...
        WHERE tbl_warehouse_history.stock_id = ".$stock_id." AND tbl_warehouse_history.date BETWEEN '".$dateFrom."' AND '".$dateTo."'
...
$pdf->Output('ItemReport_'.$description.'_'.$dateFrom.'_'.$dateTo.'.pdf', 'I');
