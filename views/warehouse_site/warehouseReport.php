...
$pdf->SetTitle('WarehouseReport_'.date('M-d-y'));
...
$txt = '
<strong>Department: </strong><i>Warehouse</i><br><br>
<table rules="all" border=".1" width="100%">
        <tr style="background-color:#313131; color:#fff;">
            <th align="center" width="5%"><i>#</i></th>
            <th align="center" width="31%">Part #</th>
            <th align="center" width="31%"> Description</th>
            <th align="center" width="31%"> Total Quantity</th>
        </tr>';
...
$pdf->Output('WarehouseReport_'.date('M-d-y').'.pdf', 'I');
